...
- (id)initWithFrame:(CGRect)frame {
    if ((self = [super initWithFrame:frame])) {
        ...
        UIImage *videoIndicatorImage = [UIImage imageForResourcePath:@"MWPhotoBrowserWithYouTubeAndVimeo.bundle/VideoOverlay" ofType:@"png" inBundle:[NSBundle bundleForClass:[self class]]];
        ...
        [_selectedButton setImage:[UIImage imageForResourcePath:@"MWPhotoBrowserWithYouTubeAndVimeo.bundle/ImageSelectedSmallOff" ofType:@"png" inBundle:[NSBundle bundleForClass:[self class]]] forState:UIControlStateNormal];
        [_selectedButton setImage:[UIImage imageForResourcePath:@"MWPhotoBrowserWithYouTubeAndVimeo.bundle/ImageSelectedSmallOn" ofType:@"png" inBundle:[NSBundle bundleForClass:[self class]]] forState:UIControlStateSelected];
...
- (void)showImageFailure {
    ...
    if (![_photo respondsToSelector:@selector(emptyImage)] || !_photo.emptyImage) {
        if (!_loadingError) {
            ...
            _loadingError.image = [UIImage imageForResourcePath:@"MWPhotoBrowserWithYouTubeAndVimeo.bundle/ImageError" ofType:@"png" inBundle:[NSBundle bundleForClass:[self class]]];
